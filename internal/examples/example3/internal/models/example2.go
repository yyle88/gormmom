...
type Example2 struct {
	...
	V名称       string `gorm:"column:V_0D54_F079;type:text" mom:"mcp:S63;"` //使用大写字母的规则
	...
	V年龄       int    `gorm:"column:v_745e_849f;index:idx_example2s_V_745E_849F" json:"age" mom:"mcp:s63;idx:CNM;"` //理论上不要直接给model添加json标签，因为那是view层的逻辑，但实际上假如非这样做也能处理
	Rank      int32
