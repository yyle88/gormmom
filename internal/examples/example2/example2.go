...
type Example struct {
	...
	V名称       string `gorm:"column:V_0D54_F079;type:text;uniqueIndex:udx_examples_V_0D54_F079" mom:"rule:S63;udx:cnm;"` //使用大写字母的规则
	V字段       string `gorm:"column:v_575b_b56b;" mom:"rule:s63;"`                                                       //使用小写字母的规则
	V性别       string `gorm:"column:v_2760_2b52;" mom:"rule:s63;"`
	V特殊       string `gorm:"column:V_7972_8A6B;type:int32;index:idx_examples_V_7972_8A6B" mom:"rule:S63;idx:cnm;"`
